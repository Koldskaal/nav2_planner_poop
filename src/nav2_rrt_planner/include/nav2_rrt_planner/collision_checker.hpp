...
#ifndef NAV2_RRT_PLANNER__COLLISION_CHECKER_HPP_
#define NAV2_RRT_PLANNER__COLLISION_CHECKER_HPP_
...
namespace nav2_rrt_planner
{
  ...
  /**
   * @class nav2_rrt_planner::GridCollisionChecker
  ...
  public:
    /**
     * @brief A constructor for nav2_rrt_planner::GridCollisionChecker
...
#endif // NAV2_RRT_PLANNER__COLLISION_CHECKER_HPP_